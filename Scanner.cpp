...
void Scanner::Init() {
	...
	keywords.set(L"float", 6);
	keywords.set(L"string", 7);
	keywords.set(L"if", 8);
	keywords.set(L"else", 9);
	keywords.set(L"print", 10);
	keywords.set(L"main", 11);
	keywords.set(L"read", 12);
	keywords.set(L"while", 13);
	keywords.set(L"void", 14);
	keywords.set(L"return", 15);
	keywords.set(L"global", 16);
	keywords.set(L"sign", 17);
